...
async function loadUserImage() {
    try {
        ...
        if (userSnap.exists()) {
            ...
            // Assuming the image URL is stored under the 'photoURL' field in Firestore
            if (userData.photoURL) {
                const userImage = document.getElementById('user_image');
                userImage.src = userData.photoURL; // Update the image source with the URL from Firestore
            } else {
                console.warn("No photo URL found for the user.");
            }
        } else {
...
// Call the function to load and display the image when the page loads
